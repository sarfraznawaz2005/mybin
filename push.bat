...
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mPulling Remote Changes...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m

git pull

echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mAdding Files...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
...
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mNothing to commit, skipping commit step...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m

:: Even if there's nothing to commit, we might still need to push if we have commits that haven't been pushed
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mChecking for commits to push...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
...
if "%COMMITS_TO_PUSH%"=="0" (
    echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
    echo %CYAN%[106m\e[30mNo commits to push, skipping push step...%CYAN%[0m
    echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
    goto :eof
)

echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mPushing...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
...
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mDONE!%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
...
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
echo %CYAN%[106m\e[30mMaking Commit Message...%CYAN%[0m
echo %CYAN%[106m\e[30m----------------------------------------%CYAN%[0m
