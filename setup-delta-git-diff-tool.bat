...
git config --global delta.plus-style                    "bold #333333 #1DD45F"
git config --global delta.plus-non-emph-style           "#333333 #1DD45F"
git config --global delta.plus-emph-style               "bold #333333 #1DD45F"
git config --global delta.plus-empty-line-marker-style  "#333333 #1DD45F"
